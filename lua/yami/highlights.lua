...
M.highlights = {
	...
	-- COMMON HIGHLIGHTS
	String = { fg = p.green, fmt = config.code_style.strings },
	...
	Identifier = { fg = p.red, fmt = config.code_style.variables },
	Constant = colors.Cyan,
	PreProc = colors.Purple,
	PreCondit = colors.Purple,
	Include = colors.Purple,
	Keyword = { fg = p.purple, fmt = config.code_style.keywords },
	Define = colors.Purple,
	Typedef = colors.Purple,
	Exception = colors.Purple,
	Conditional = { fg = p.purple, fmt = config.code_style.keywords },
	Repeat = { fg = p.purple, fmt = config.code_style.keywords },
	...
	Function = { fg = p.blue, fmt = config.code_style.functions },
	Operator = colors.Purple,
	Title = colors.Cyan,
	Tag = colors.Green,
	Delimiter = colors.LightGrey,
	Comment = { fg = p.grey, fmt = config.code_style.comments },
	SpecialComment = { fg = p.grey, fmt = config.code_style.comments },
	Todo = { fg = p.red, fmt = config.code_style.comments },
	...
	["@comment"] = { fg = p.grey, fmt = config.code_style.comments },
	["@conditional"] = { fg = p.purple, fmt = config.code_style.keywords },
	["@constant"] = { fg = p.orange, fmt = config.code_style.constants },
	["@constant.builtin"] = { fg = p.orange, fmt = config.code_style.constants },
	["@constant.macro"] = { fg = p.orange, fmt = config.code_style.constants },
	...
	["@float"] = colors.Orange,
	["@function"] = { fg = p.blue, fmt = config.code_style.functions },
	["@function.builtin"] = { fg = p.cyan, fmt = config.code_style.functions },
	["@function.macro"] = { fg = p.cyan, fmt = config.code_style.functions },
	["@include"] = colors.Purple,
	["@keyword"] = { fg = p.purple, fmt = config.code_style.keywords },
	["@keyword.function"] = { fg = p.purple, fmt = config.code_style.functions },
	["@keyword.operator"] = { fg = p.purple, fmt = config.code_style.keywords },
	["@label"] = colors.Red,
	["@method"] = { fg = p.blue, fmt = config.code_style.functions },
	...
	["@repeat"] = { fg = p.purple, fmt = config.code_style.keywords },
	["@string"] = { fg = p.green, fmt = config.code_style.strings },
	["@string.regex"] = { fg = p.orange, fmt = config.code_style.strings },
	["@string.escape"] = { fg = p.red, fmt = config.code_style.strings },
	["@symbol"] = colors.Cyan,
	["@tag"] = colors.Purple,
	...
	["@text.todo"] = { fg = p.red, fmt = config.code_style.comments },
	["@text.math"] = { fg = p.fg },
	...
	["@variable"] = { fg = p.fg, fmt = config.code_style.variables },
	["@variable.builtin"] = { fg = p.red, fmt = config.code_style.variables },
	...
	CmpItemKind = { fg = p.purple, fmt = config.cmp_itemkind_reverse and "reverse" },
	...
	HopNextKey2 = { fg = p.green, fmt = "bold" },
	...
	MiniStarterInactive = { fg = p.grey, fmt = config.code_style.comments },
	...
	-- PHP
	phpFunctions = { fg = p.fg, fmt = config.code_style.functions },
	phpMethods = colors.Cyan,
	phpStructure = colors.Purple,
	phpOperator = colors.Purple,
	phpMemberSelector = { fg = p.fg },
	phpVarSelector = { fg = p.orange, fmt = config.code_style.variables },
	phpIdentifier = { fg = p.orange, fmt = config.code_style.variables },
	phpBoolean = colors.Cyan,
	phpNumber = colors.Orange,
	phpHereDoc = colors.Green,
	phpNowDoc = colors.Green,
	phpSCKeyword = { fg = p.purple, fmt = config.code_style.keywords },
	phpFCKeyword = { fg = p.purple, fmt = config.code_style.keywords },
	...
	scalaKeywordModifier = { fg = p.red, fmt = config.code_style.keywords },

	-- LaTeX
	latexTSInclude = colors.Blue,
	latexTSFuncMacro = { fg = p.fg, fmt = config.code_style.functions },
	...
	vimVar = { fg = p.fg, fmt = config.code_style.variables },
	vimCommentTitle = { fg = p.light_grey, fmt = config.code_style.comments },
}
