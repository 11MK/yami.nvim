...
M.highlights = {
	...
	-- COMMON HIGHLIGHTS
	String = { fg = p.green, config.code_style.strings },
	...
	Identifier = { fg = p.red, config.code_style.variables },
	Constant = colors.Cyan,
	PreProc = colors.Purple,
	PreCondit = colors.Purple,
	Include = colors.Purple,
	Keyword = { fg = p.purple, config.code_style.keywords },
	Define = colors.Purple,
	Typedef = colors.Purple,
	Exception = colors.Purple,
	Conditional = { fg = p.purple, config.code_style.keywords },
	Repeat = { fg = p.purple, config.code_style.keywords },
	...
	Function = { fg = p.blue, config.code_style.functions },
	Operator = colors.Purple,
	Title = colors.Cyan,
	Tag = colors.Green,
	Delimiter = colors.LightGrey,
	Comment = { fg = p.grey, config.code_style.comments },
	SpecialComment = { fg = p.grey, config.code_style.comments },
	Todo = { fg = p.red, config.code_style.comments },
	...
	["@comment"] = { fg = p.grey, config.code_style.comments },
	["@conditional"] = { fg = p.purple, config.code_style.keywords },
	["@constant"] = { fg = p.orange, config.code_style.constants },
	["@constant.builtin"] = { fg = p.orange, config.code_style.constants },
	["@constant.macro"] = { fg = p.orange, config.code_style.constants },
	...
	["@float"] = colors.Orange,
	["@function"] = { fg = p.blue, config.code_style.functions },
	["@function.builtin"] = { fg = p.cyan, config.code_style.functions },
	["@function.macro"] = { fg = p.cyan, config.code_style.functions },
	["@include"] = colors.Purple,
	["@keyword"] = { fg = p.purple, config.code_style.keywords },
	["@keyword.function"] = { fg = p.purple, config.code_style.functions },
	["@keyword.operator"] = { fg = p.purple, config.code_style.keywords },
	["@label"] = colors.Red,
	["@method"] = { fg = p.blue, config.code_style.functions },
	...
	["@repeat"] = { fg = p.purple, config.code_style.keywords },
	["@string"] = { fg = p.green, config.code_style.strings },
	["@string.regex"] = { fg = p.orange, config.code_style.strings },
	["@string.escape"] = { fg = p.red, config.code_style.strings },
	["@symbol"] = colors.Cyan,
	["@tag"] = colors.Purple,
	...
	["@text.todo"] = { fg = p.red, config.code_style.comments },
	["@text.math"] = { fg = p.fg },
	...
	["@variable"] = { fg = p.fg, config.code_style.variables },
	["@variable.builtin"] = { fg = p.red, config.code_style.variables },
	...
	MiniStarterInactive = { fg = p.grey, config.code_style.comments },
	...
	-- PHP
	phpFunctions = { fg = p.fg, config.code_style.functions },
	phpMethods = colors.Cyan,
	phpStructure = colors.Purple,
	phpOperator = colors.Purple,
	phpMemberSelector = { fg = p.fg },
	phpVarSelector = { fg = p.orange, config.code_style.variables },
	phpIdentifier = { fg = p.orange, config.code_style.variables },
	phpBoolean = colors.Cyan,
	phpNumber = colors.Orange,
	phpHereDoc = colors.Green,
	phpNowDoc = colors.Green,
	phpSCKeyword = { fg = p.purple, config.code_style.keywords },
	phpFCKeyword = { fg = p.purple, config.code_style.keywords },
	...
	scalaKeywordModifier = { fg = p.red, config.code_style.keywords },

	-- LaTeX
	latexTSInclude = colors.Blue,
	latexTSFuncMacro = { fg = p.fg, config.code_style.functions },
	...
	vimVar = { fg = p.fg, config.code_style.variables },
	vimCommentTitle = { fg = p.light_grey, config.code_style.comments },
}
